...
function addInventory(product, number) {
    ...
    console.log(number + " " + product.name + "s added to the inventory")
}
...
function processSale(product, sold) {
        product.invetory -= sold
        let total_sale = product.unit_price * sold
        console.log(sold + " " + product.name + " sold")
        return total_sale
}
...
"Total sale: $20"
*/
console.log("The total sale: " + processSale(product, 1))
